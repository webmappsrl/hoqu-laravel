                    ...
                    <div class="container mx-auto px-6 py-2">
                        <div class="flex flex-col mt-8">
                            ...
                            <div class="max-w-sm rounded overflow-hidden">
                                <form method='POST' action="{{ route('reschedule',['task'=>$task]) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="field mb-8">
                                        <div class='control'>
                                            <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md bg-gray-400" role="alert">
                                                ...
                                                <p class="text-3xl">remember that the applied change will be irreversible</p>
                                                <p class="text-3xl m-8">you are changing the status of ID: {{$task->id}} are you sure you want to proceed? </p>
                                                  </div>
                                                </div>
                                              </div>
                                        </div>
                                    ...
                                    <div class="field is-grouped">
                                        <div class='control'>
                                            <button class="bg-transparent hover:bg-red text-red-dark font-semibold hover:text-red py-2 px-4 m-8 border border-red hover:border-transparent rounded">
                                                OK
                                            </button>
                                        </div>
