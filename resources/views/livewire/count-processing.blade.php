<div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
    <div class="p-3 rounded-full bg-orange-600 bg-opacity-75">
       <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-bricks" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <h4 class="text-2xl font-semibold text-gray-700">{{ $count_processing }}</h4>
