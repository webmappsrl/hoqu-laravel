                            ...
                            @foreach ($tasks as $index => $task)
                                <tr>
                                    <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <label class="inline-flex items-center mt-3">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-red-600" value="{{$task->id }}" wire:model="selectedErrors.{{$task->id }}" >
                                        </label>
                                    </td>
                                    <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                    ...
                                    <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="flex justify-center bg-grey-lighter mb-1 text-sm leading-3 text-gray-900">
                                            <button data-toggle="modal" data-target="#updateModal" wire:click="edit({{$task}})" class="bg-white text-gray-800 font-bold rounded border-b-2 border-indigo-500 hover:border-indigo-600 hover:bg-indigo-500  hover:text-white shadow-md py-2 px-6 inline-flex items-center">
